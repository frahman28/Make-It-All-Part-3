...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.0&nocache=6515349755ltr&server=1">
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/printview.css?v=5.1.0" media="print" id="printcss">
    <title>phpmyadmin.sci-project.lboro.ac.uk / localhost | phpMyAdmin 5.1.0</title>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/messages.php?l=en&amp;v=5.1.0"></script>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/dist/export_output.js?v=5.1.0"></script>
...
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"en",server:"1",table:"",db:"",token:"72617b412a6045547633306e712f2a72",text_dir:"ltr",show_databases_navigation_as_tree:true,pma_text_default_tab:"Browse",pma_text_left_default_tab:"Structure",pma_text_left_default_tab2:false,LimitChars:"50",pftext:"",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:true,rootPath:"/",arg_separator:"&",PMA_VERSION:"5.1.0",auth_type:"cookie",user:"teamb015"});
...
<body>
    ...
    <div id="pma_navigation_content">
      <div id="pma_navigation_header">
        ...
        <div id="navipanellinks">
          ...
          <a href="./url.php?url=https%3A%2F%2Fdocs.phpmyadmin.net%2Fen%2Flatest%2Findex.html" title="phpMyAdmin documentation" target="_blank" rel="noopener"><img src="themes/dot.gif" title="phpMyAdmin documentation" alt="phpMyAdmin documentation" class="icon ic_b_docs"></a>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&amp;db=teamb015&amp;table=job_info">`teamb015`.`job_info`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&amp;db=teamb015&amp;table=hardware_relation">`teamb015`.`hardware_relation`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&amp;db=teamb015&amp;table=hardware">`teamb015`.`hardware`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&amp;db=teamb015&amp;table=os">`teamb015`.`os`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&amp;db=teamb015&amp;table=software">`teamb015`.`software`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&amp;db=teamb015&amp;table=login_info">`teamb015`.`login_info`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&amp;db=teamb015&amp;table=employees">`teamb015`.`employees`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&amp;db=teamb015&amp;table=type_of_software">`teamb015`.`type_of_software`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&amp;db=teamb015&amp;table=type_of_hardware">`teamb015`.`type_of_hardware`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&amp;db=teamb015&amp;table=solutions">`teamb015`.`solutions`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  <ul>
    <li class="first database"><div class='block'><i class='first'></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.aW5mb3JtYXRpb25fc2NoZW1h" data-vpath="cm9vdA==.aW5mb3JtYXRpb25fc2NoZW1h" data-pos="0""></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=information_schema&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=information_schema' title='Structure'>information_schema</a><div class="clearfloat"></div></li><li class="last database"><div class='block'><i></i><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.dGVhbWIwMTU=" data-vpath="cm9vdA==.dGVhbWIwMTU=" data-pos="0""></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=teamb015&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=teamb015' title='Structure'>teamb015</a><div class="clearfloat"></div></li>
  </ul>
</div>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="72617b412a6045547633306e712f2a72">
...
<table class="pma-table" width="100%" cellspacing="0">
<tr><th><label for="MaxNavigationItems">Maximum items in branch</label><span class="doc"><a href="./url.php?url=https%3A%2F%2Fdocs.phpmyadmin.net%2Fen%2Flatest%2Fconfig.html%23cfg_MaxNavigationItems" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
...
<div id="topmenucontainer" class="menucontainer">
  ...
  <div id="pma_console_container">
    ...
    <div class="message collapsed bookmark" bookmarkid="1"
        ...
        <span class="query">
            SELECT Ticket.ID AS ID, CreatedTimestamp, 
...
<p>index.php: Missing parameter: what<a href="./url.php?url=https%3A%2F%2Fdocs.phpmyadmin.net%2Fen%2Flatest%2Ffaq.html%23faqmissingparameters" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a><br>index.php: Missing parameter: export_type<a href="./url.php?url=https%3A%2F%2Fdocs.phpmyadmin.net%2Fen%2Flatest%2Ffaq.html%23faqmissingparameters" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a><br></p>
</body>
</html>
  </div>
